    ...
    def _sizeChangedWrapper(app, event=None):
        ...
        if (app._lastWindowDims is None):
            ...
            if (app._lastWindowDims != newDims):
                ...
                app.updateTitle()
                app.sizeChanged()
                app.cellHeight = (app.height-2*app.margin)/6 #added by cindyxio
                app.cellWidth = app.cellHeight*2/3 #added by cindyxio
                app.text = int(app.height//60) #added by cindyxio
